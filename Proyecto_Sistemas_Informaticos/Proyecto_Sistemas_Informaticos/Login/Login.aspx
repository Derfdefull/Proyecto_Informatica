<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="Proyecto_Sistemas_Informaticos.Login" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style type="text/css">
        ...
        .auto-style7 {
            ...
            width: 400px;
            height: 600px;
            background-image: url('../Contenidos/Imagenes/led.png');
    ...
    <form id="form1" runat="server" class="auto-style1">
        ...
        <table>
            <tr>
                ...
                <td><div class=" contenedor3">
<br />
<br />
<br />
<br />
	<table id="log" class="auto-style8 ">
